...
export default {
    emailAdminWelcomeInstructions(email, name, token) {
        ...
        let mailOptions = {
            ...
            text: 'Hi Thanks for joining Veniqa as an admin. Before you can login, please click the link below to reset your login password Once you reset your password, you will be redirected to the login page.',
